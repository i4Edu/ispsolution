...
This document provides guidance for AI developers working on the ISP Solution project. All development must adhere to the architecture and principles outlined in `Mikrotik_Radius_architecture.md`.
...
1.  **Read the Architecture Document**: Before making any changes, review `Mikrotik_Radius_architecture.md` to understand the system design.
